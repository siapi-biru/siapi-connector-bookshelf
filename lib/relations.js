...
module.exports = {
  ...
  async update(params, { transacting } = {}) {
    ...
    const values = Object.keys(removeUndefinedKeys(params.values)).reduce((acc, current) => {
      ...
      const assocModel = siapi.db.getModel(details.model || details.collection, details.plugin);
      ...
      switch (association.nature) {
        ...
        case 'manyMorphToOne': {
          ...
          refs.forEach(obj => {
            const targetModel = siapi.db.getModel(
              obj.ref,
        ...
        case 'manyToManyMorph': {
          ...
          const model = siapi.db.getModel(details.collection || details.model, details.plugin);
